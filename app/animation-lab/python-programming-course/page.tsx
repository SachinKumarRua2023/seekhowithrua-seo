// ═══════════════════════════════════════════════════════════════
// REPO FILE:  seekhowithrua-seo/app/animation-lab/python-programming-course/page.tsx
// LIVE URL:   https://seekhowithrua.com/animation-lab/python-programming-course
...
export const metadata: Metadata = {
  title: "Python Programming Animations — 3D Visual Learning | SeekhoWithRua",
  description: "Learn Python Programming through 3D animations and visual explainers. See python memory model animated in your browser. Free visual learning for school, college & IT students India.",
  keywords: "animated Python course India, visual Python tutorial, 3D Python memory model, animated list dictionary animation, Python function animation India, visual OOP animation Python, animated Python for beginners India, Python data structure animation, 3D Python explainer India, visual coding Python tutorial",
  openGraph: {
    title: "Python Programming — 3D Animated Course | SeekhoWithRua",
    description: "See Python Programming concepts animated in 3D. Visual learning that makes complex ideas click instantly.",
    url: "https://seekhowithrua.com/animation-lab/python-programming-course",
    siteName: "SeekhoWithRua",
    type: "website",
  },
  alternates: { canonical: "https://seekhowithrua.com/animation-lab/python-programming-course" },
};

const ANIMATIONS = [
  {
    "name": "Python memory model",
    "desc": "Variables as labels pointing to objects in memory. Watch what happens during assignment, mutation, and garbage collection."
  },
  {
    "name": "Call stack visualised",
    "desc": "Function calls stacked as frames. Local variables shown inside each frame. Watch frames push and pop during recursion."
  },
  {
    "name": "List vs tuple internals",
    "desc": "A list as a dynamic array that resizes. A tuple as a fixed block. Watch memory allocation as you append items."
  },
  {
    "name": "Dictionary hash table",
    "desc": "Keys hashed to bucket positions. Collisions resolved. Watch lookups happen in O(1) with the bucket highlighted."
  },
  {
    "name": "Class inheritance tree",
    "desc": "A 3D tree of classes and methods. Method resolution order (MRO) animated as a path through the tree."
  },
  {
    "name": "Generator and iterator",
    "desc": "A generator function animated as a paused coroutine. Each `next()` call resumes from the yield point."
  }
];
  ...
  return (
    <>
      <style>{`
        ...
        :root{--c:#ec4899;--fg:#1a1a2e;--fg2:#5a5a72;--bg:#fafaf8;--card:#fff;--border:rgba(0,0,0,.08);--font:'Syne',sans-serif;--mono:'JetBrains Mono',monospace}
        ...
        .hero::before{content:'';position:absolute;inset:0;background:radial-gradient(ellipse 60% 40% at 50% 0%,color-mix(in srgb,#ec4899 15%,transparent) 0%,transparent 70%);pointer-events:none}
      ...
      <main className="p">
        ...
        <section className="hero">
          <div className="breadcrumb"><Link href="/animation-lab">Animation Lab</Link> / Python Programming</div>
          <h1 className="h1">See <span className="accent">Python</span> before you code it</h1>
          <p className="sub">Memory model, call stack, list internals, dictionary hash tables, OOP class hierarchies — Python's invisible machinery made visible.</p>
          <div className="cta-row">
            <a href="https://animationlab.seekhowithrua.com/python-programming-course" className="btn-p" target="_blank" rel="noopener noreferrer">Watch Animations →</a>
            <Link href="/python-programming-course" className="btn-o">Go to Python Programming Course</Link>
          </div>
        </section>
        ...
        <div className="bottom">
          <h2>Watch the Python Programming animations</h2>
          <p>Open Animation Lab and select Python Programming to start watching. Free, no sign-up needed.</p>
          <div className="cta-row">
            <a href="https://animationlab.seekhowithrua.com/python-programming-course" className="btn-p" target="_blank" rel="noopener noreferrer">Open Animations →</a>
            <Link href="/python-programming-course" className="btn-o">Start Python Programming Course →</Link>
          </div>
        </div>
      </main>
    </>
